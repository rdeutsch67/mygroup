...
namespace Template_Angular7.Data
{
    public class ApplicationDbContext : DbContext
    {
            ...
            modelBuilder)
        {
            ...
            modelBuilder.Entity<AppUser>().ToTable("TAppUser");
            modelBuilder.Entity<AppUser>().Property(i => i.Id).ValueGeneratedOnAdd();
            modelBuilder.Entity<AppUser>().HasMany(u => u.Gruppen).WithOne(i => i.User);
